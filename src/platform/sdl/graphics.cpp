...
bool initGraphics(Graphics& graphics){
    ...
    SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, graphics.SCREEN_WIDTH, graphics.SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
    ...
    graphics.fonts.score = TTF_OpenFont("../assets/fonts/Pacifico.ttf", 24);
    graphics.fonts.gameOver = TTF_OpenFont("../assets/fonts/Spectral/Spectral-Bold.ttf", 72);
    graphics.fonts.hint = TTF_OpenFont("../assets/fonts/Spectral/Spectral-Medium.ttf", 28);
